                ...
                <div class="m-5">
                    ...
                    <form action="{{ route('travel.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="destination" id="destination" placeholder="Masukkan Tujuan"
                        ...
                        <div>
                            ...
                            <input type="number" name="passenger_quota" id="passenger_quota"
                        ...
                        <div>
                            ...
                            <input type="number" name="ticket_price" id="ticket_price" placeholder="Masukkan Harga"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
